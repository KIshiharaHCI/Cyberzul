 ...
 */
public class TileDestinationWall extends TileDestination implements TileAcceptor {

  public TileDestinationWall(int cell, int row, TileClickListener tileClickListener,
      ModelTile modelTile) {
