...
public class Tile extends JPanel {
  ...
  static final String BLACK_TILE_PATH = "img/black-tile.png";
  static final String BLUE_TILE_PATH = "img/blue-tile.png";
  static final String RED_TILE_PATH = "img/red-tile.png";
  static final String WHITE_TILE_PATH = "img/white-tile.png";
  //TODO: make yellow, and in model yellow too
  static final String ORANGE_TILE_PATH = "img/yellow-tile.png";
  static final String STARTING_PLAYER_MARKER_PATH = "img/start-player-button.png";
  ...
  public Tile(ModelTile modelTile) {
    this.modelTile = modelTile;
    initialize();
  ...
  void initialize() {
    ...
    boolean empty = getModelTile().equals(ModelTile.EMPTY_TILE);
    this.icon = empty ? null : getLabelIcon(modelTile);

    label = empty ? new JLabel("") : new JLabel(icon);
    add(label);
  }
   ...
   */
  ImageIcon getResizedImageIcon(String path) {
