...
/**
 * Super class for FactoryDisplays and Table Centers.
...
public abstract class Offering extends Bag{
  ...
  /**
   * The Tiles on this Offering are saved in a List. By telling this Offering the index of the tile that
   * should be chosen, it returns all tiles of the same color. This method has side effects based on
   * the specific type (e.g. Factory Display or Table Center). These side effects don't effect the
   * return value or the way how this Offering should be used.
   *
