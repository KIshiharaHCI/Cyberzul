...
public class WallBackgroundPattern {
    ...
    private static final ModelTile[][] templateWall =
            {{ModelTile.BLUE_TILE, ModelTile.ORANGE_TILE, ModelTile.RED_TILE, ModelTile.BLACK_TILE, ModelTile.WHITE_TILE},
                    {ModelTile.WHITE_TILE, ModelTile.BLUE_TILE, ModelTile.ORANGE_TILE, ModelTile.RED_TILE, ModelTile.BLACK_TILE},
                    {ModelTile.BLACK_TILE, ModelTile.WHITE_TILE, ModelTile.BLUE_TILE, ModelTile.ORANGE_TILE, ModelTile.RED_TILE},
                    {ModelTile.RED_TILE, ModelTile.BLACK_TILE, ModelTile.WHITE_TILE, ModelTile.BLUE_TILE, ModelTile.ORANGE_TILE},
                    {ModelTile.ORANGE_TILE, ModelTile.RED_TILE, ModelTile.BLACK_TILE, ModelTile.WHITE_TILE, ModelTile.BLUE_TILE}};
